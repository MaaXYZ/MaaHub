...
![architecture](https://raw.githubusercontent.com/MaaXYZ/MaaFramework/main/docs/static/architecture.png)

基于本项目进行开发的大部分时间围绕编写项目资源进行。只需正确配置 `interface.json` 文件，就可以通过社区提供的[通用 UI](https://github.com/MaaXYZ/MaaFramework/blob/main/README.md#通用-ui)运行。在进行开发前，请务必熟悉以下术语。
